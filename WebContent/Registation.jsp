	...
	<center>
			...
			<form action="Registation" method="post">
				<table>
					...
					<tr>
						<td>Re-Enter Password:</td><td><input type="password" name="re-enter" required="required"></td>
						<td>
					...
					<tr>
						<td>Mobile No:</td><td><input type="text" name = "mobileno" required="required"></td>
					</tr>
					<tr>
						<td>
							<div>
