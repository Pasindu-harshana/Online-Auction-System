...
<body>
	...
	<center>
		...
		<form action = "SellerRegistation" method="post">
			<table>
				<tr>
					<td>Seller Name: </td>
					<td><input type = "text" name ="sellername" required="required"></td>
				</tr>
				<tr>
					<td>Seller Password: </td>
					<td><input type = "password" name="sellerpass" required ="required"></td>
				</tr>
				<tr>
					<td>Re-Enter Password:</td>
					<td><input type="password" name ="re-enter" required="required"></td>
					<td>
